          ...
          <ul className="hero-hobbies-list">
            <li className="hobby-card">
              <Link to="hobby/bartending">
                <img src="/images/bartending.jpg" alt="bartending" className="hobby-image" />
              </Link>
            </li>
            <li className="hobby-card">
              <Link to="hobby/hiking">
                <img src="/images/teddy_dinosaur.jpg" alt="teddy and dinosaur" className="hobby-image" />
              </Link>
            </li>
            <li className="hobby-card">
              <Link to="hobby/darts">
                <img src="/images/darts.jpg" alt="darts" className="hobby-image" />
              </Link>
            </li>
            <li className="hobby-card">
              <Link to="hobby/gaming">
                <img src="/images/gaming.jpg" alt="gaming" className="hobby-image" />
              </Link>
            </li>
            <li className="hobby-card">
              <Link to="hobby/baseball">
                <img src="/images/baseball.jpg" alt="baseball" className="hobby-image" />
              </Link>
            </li>
            <li className="hobby-card">
              <Link to="hobby/cooking">
                <img src="/images/cooking.jpg" alt="cooking" className="hobby-image" />
              </Link>
            </li>
            <li className="hobby-card">
              <Link to="hobby/disc_golf">
                <img src="/images/disc_golf.jpg" alt="disc golf" className="hobby-image" />
              </Link>
            </li>
